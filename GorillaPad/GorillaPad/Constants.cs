...
namespace GorillaPad
{
    internal class Constants
    {
        ...
        public static readonly TransformState Chest = new(new Vector3(-0.001f, 0.16f, 0.15f), Quaternion.Euler(89.6948f, 97.7934f, 98.5541f), new Vector3(0.15f, 0.15f, 0.15f));
