...
namespace GorillaPad
{
    internal class Constants
    {
        ...
        public static readonly TransformState LeftHand = new(new Vector3(-0.149f, 0.0532f, 0.0552f), Quaternion.Euler(90f, 90f, 0f), new Vector3(.08f, .08f, .08f));
        public static readonly TransformState RightHand = new(new Vector3(0.1104f, 0.1137f, 0.0552f), Quaternion.Euler(43.8616f, 60.3276f, 329.0535f), new Vector3(.08f, .08f, .08f));
    }
}