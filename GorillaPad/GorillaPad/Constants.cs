...
namespace GorillaPad
{
    internal class Constants
    {
        ...
        public static readonly TransformState AssetPosition = new(new Vector3(-68.4413f, 11.3857f, -81.3887f), Quaternion.Euler(0, 100, 0), new Vector3(.06f, .06f, .06f));

        public static readonly TransformState SignPosition = new(new Vector3(-68.4413f, 11.3857f, -81.3887f), Quaternion.Euler(0, 100, 0), new Vector3(.06f, .06f, .06f));
